...
public class Chapter3_1 {
	...
	/**
	 * catch exception in lambda expression 1. In the interface declaration
	 * throws exception, when use interface it will throw the exception 2. In
	 * the implementation of interface, catch the exception
	 *
	 */
	...
	/**
	 * There are two contructors. One is with the value, one is not. Contruct a
	 * object Apple without values. use Supplier class
	 */
	...
	public void getAppleWithParam(String name, int price, int weight) {
		...
		// implement function class as list, input function is constructor
		// method.
